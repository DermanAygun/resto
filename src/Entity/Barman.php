...
class Barman
{
    ...
    public function getDrankNaam(): ?string
    {
        return $this->drank_naam;
    }

    public function setDrankNaam(string $drank_naam): self
    {
        $this->drank_naam = $drank_naam;
    ...
    {
        return (string) $this->getDrankNaam();
    }
}
